...
curl -fsSL https://raw.githubusercontent.com/axetroy/cross-env/main/install.sh | bash
# install the specified version
curl -fsSL https://raw.githubusercontent.com/axetroy/cross-env/main/install.sh | bash -s v0.1.0
```
